...
An Refferals Bonus App written on [Ruby](https://www.ruby-lang.org) and [Rails framework](https://rubyonrails.org/).
...
```
git clone git@github.com:nxd1184/referrals-bonus.git
cd referrals-bonus
bundle install
```
